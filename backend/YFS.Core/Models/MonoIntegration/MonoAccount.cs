...
namespace YFS.Core.Models.MonoIntegration
{
    public class MonoAccount
    {
        ...
        public string type { get; set; }    //	Enum: "black" "white" "platinum" "iron" "fop" "yellow" "eAid"
        public int currencyCode { get; set; }   //  Код валюти рахунку відповідно ISO 4217
        public string cashbackType { get; set; }    //Enum: "None" "UAH" "Miles"   Тип кешбеку який нараховується на рахунок
